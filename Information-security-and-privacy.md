...
- [Information Security and Privacy](#information-security-and-privacy)
  - [Introduction to cyber threats](#introduction-to-cyber-threats)
    - [Motivation for attacks](#motivation-for-attacks)
    - [Value of a hacked PC](#value-of-a-hacked-pc)
    - [Cyber attack lifecycle](#cyber-attack-lifecycle)
    - [Commodity threats](#commodity-threats)
      - [Malware spam](#malware-spam)
      - [Extorsion](#extorsion)
    - [Hacktivism](#hacktivism)
      - [Examples of Hacktivism](#examples-of-hacktivism)
    - [Advanced Persistent Threat](#advanced-persistent-threat)
      - [Example of APT: RUAG](#example-of-apt-ruag)
    - [Classes of Malware](#classes-of-malware)
      - [Virus](#virus)
      - [Worm](#worm)
      - [Trojan](#trojan)
      - [Rootkit](#rootkit)
      - [Ransomware](#ransomware)
      - [Nation-stae Malware: Stuxnet](#nation-stae-malware-stuxnet)
      - [Botnets - compute for hire](#botnets---compute-for-hire)
    - [Social engineering](#social-engineering)
    - [Vulnerabilities and exploits](#vulnerabilities-and-exploits)
      - [Typical software vulnerabilities](#typical-software-vulnerabilities)
  - [Exercises 1](#exercises-1)
  - [Crypto Basics](#crypto-basics)
    - [Naive approach to encryption](#naive-approach-to-encryption)
      - [Rotation cipher](#rotation-cipher)
    ...
    - [Public-key cryptography](#public-key-cryptography)
      ...
      - [RSA](#rsa)
      - [Eliptic curve cryptography (ECC)](#eliptic-curve-cryptography-ecc)
      - [Crypto Comparison](#crypto-comparison)
    - [Public key distribution](#public-key-distribution)
      - [Certificate Authority](#certificate-authority)
    - [Crypto summary](#crypto-summary)
    - [Case study: TLS](#case-study-tls)
      - [Building blocks](#building-blocks)
      - [Cipher Suites](#cipher-suites)
      - [Perfect Forward Security](#perfect-forward-security)
      - [TLS uses public and symmetric crypto](#tls-uses-public-and-symmetric-crypto)
      - [Weaknesses in TLS](#weaknesses-in-tls)
      - [Implementing TLS](#implementing-tls)
      - [Deploying TLS on the Internet](#deploying-tls-on-the-internet)
      - [Let's encrypt - Free certificates](#lets-encrypt---free-certificates)
      - [Attacks on HTTPS and defences](#attacks-on-https-and-defences)
  ...
  - [Access control](#access-control)
    - [Basics](#basics)
      ...
      - [Multiple levels of access control](#multiple-levels-of-access-control)
    - [Multiple Approaches to access control](#multiple-approaches-to-access-control)
      - [RBAC](#rbac)
        - [Example RBAC implementation - OS](#example-rbac-implementation---os)
        - [RBAC Pros](#rbac-pros)
        - [RBAC Cons](#rbac-cons)
      - [Discretionary Access Control (DAC)](#discretionary-access-control-dac)
        - [DAC in Unix FS](#dac-in-unix-fs)
        - [Capabilities in Linux](#capabilities-in-linux)
        - [ACL in Windows](#acl-in-windows)
        - [Capabilities in Windows](#capabilities-in-windows)
      - [DAC pros and cons](#dac-pros-and-cons)
      - [Mandatory access control (MAC)](#mandatory-access-control-mac)
        - [MAC Confidentiality vs Integrity](#mac-confidentiality-vs-integrity)
        - [MAC in Windows](#mac-in-windows)
        - [MAC in Linux](#mac-in-linux)
        - [MAC pros and cons](#mac-pros-and-cons)
      - [Summary of access control](#summary-of-access-control)
    - [Authentication](#authentication)
      - [Even strong passwords are at risk](#even-strong-passwords-are-at-risk)
      - [Password managers](#password-managers)
      - [Authentication/session cookies](#authenticationsession-cookies)
      - [Something you own](#something-you-own)
      - [OATH, generation of OTP](#oath-generation-of-otp)
        - [OATH algorithms](#oath-algorithms)
      - [RSA Secure IDs](#rsa-secure-ids)
      - [U2F, FIDO2](#u2f-fido2)
      - [Biometrics](#biometrics)
    - [Authentication protocols](#authentication-protocols)
      - [Challenge-response](#challenge-response)
      - [Kerberos](#kerberos)
        - [Kerberos tickets, authenticators](#kerberos-tickets-authenticators)
        - [Kerberos authentication server, ticket server](#kerberos-authentication-server-ticket-server)
        - [Kerberos authentication](#kerberos-authentication)
        - [Kerberos authorization](#kerberos-authorization)
        - [Kerberos access](#kerberos-access)
        - [Kerberos discussion](#kerberos-discussion)
        - [Kerberos attacks](#kerberos-attacks)
        - [Kerberos pre-authentication](#kerberos-pre-authentication)
        - [Kerberos symmetric keys](#kerberos-symmetric-keys)
    - [Delegated authentication](#delegated-authentication)
      - [OAUTH2](#oauth2)
        - [Roles](#roles)
          - [Typical Oauth2 flow](#typical-oauth2-flow)
        - [Oauth2 authentication only](#oauth2-authentication-only)
  ...
  - [Data Security](#data-security)
    ...
    - [Database access control](#database-access-control)
      - [Layers](#layers)
      - [Hardware access control](#hardware-access-control)
      - [OS access control](#os-access-control)
      - [Discretionary DB access control](#discretionary-db-access-control)
      - [Network access control](#network-access-control)
      - [Application access control](#application-access-control)
      - [Example: SQL injection](#example-sql-injection)
    - [Encrypting the data](#encrypting-the-data)
      - [Encrypting data at rest](#encrypting-data-at-rest)
      - [Encrypting data in motion](#encrypting-data-in-motion)
      - [Encrypting data in use by the applicaiton](#encrypting-data-in-use-by-the-applicaiton)
    - [Password storage](#password-storage)
      - [Hashing](#hashing)
        - [Importance of salt](#importance-of-salt)
        - [Time-memory trade-off](#time-memory-trade-off)
      - [Storing hashes with salt and iterations](#storing-hashes-with-salt-and-iterations)
      - [Memory hard function hashin](#memory-hard-function-hashin)
        - [Memmory hard function](#memmory-hard-function)
      - [Password storage in Linux](#password-storage-in-linux)
    - [Secure remote password protocol](#secure-remote-password-protocol)
  - [Exercises 4](#exercises-4)
  - [Programming languages security](#programming-languages-security)
    - [Motivation](#motivation)
      - [Consequences of memory safety vulnerabilities](#consequences-of-memory-safety-vulnerabilities)
    - [Type safety](#type-safety)
      - [Static/Dynamic Typing](#staticdynamic-typing)
      - [Declared/Inferred types](#declaredinferred-types)
      - [Strict/Relaxed](#strictrelaxed)
      - [Why is C Type system so ugly/flexible?](#why-is-c-type-system-so-uglyflexible)
      - [Type safety and security](#type-safety-and-security)
      - [Type confusion bugs are exploitable](#type-confusion-bugs-are-exploitable)
    - [Memory safety](#memory-safety)
      - [Memory corruption](#memory-corruption)
      - [Spatial memory safety error](#spatial-memory-safety-error)
      - [Temporal memory safety error](#temporal-memory-safety-error)
      - [Implementation](#implementation)
        - [Bounds Checking](#bounds-checking)
        - [Overhead of bounds checking](#overhead-of-bounds-checking)
        - [Automated Storage reclamation](#automated-storage-reclamation)
        - [Temporal memory safety and security](#temporal-memory-safety-and-security)
        - [Reference counting](#reference-counting)
      - [Garbage collection (GC)](#garbage-collection-gc)
        - [GC overhead](#gc-overhead)
      - [Rust](#rust)
        - [Rust Ownership](#rust-ownership)
        - [Rust reference counting](#rust-reference-counting)
    ...
    - [Sandboxing and comparmentalization](#sandboxing-and-comparmentalization)
      - [Sandboxing](#sandboxing)
        - [Sandboxing example](#sandboxing-example)
      - [Compartmentalization](#compartmentalization)
        - [Chromium](#chromium)
      - [Compartmentalization in PL](#compartmentalization-in-pl)
  - [Exercises 5](#exercises-5)
  - [Web and software security](#web-and-software-security)
    - [OWASP Top 10](#owasp-top-10)
    - [Arbitrary code execution](#arbitrary-code-execution)
      - [SQL injection](#sql-injection)
      - [LDAP pnjection](#ldap-pnjection)
      - [Command injection](#command-injection)
      - [XSS](#xss)
      - [Protection against injection](#protection-against-injection)
  ...
  - [Automated Testing](#automated-testing)
    ...
    - [Limitations of testing](#limitations-of-testing)
    ...
    - [Semi-automated testing](#semi-automated-testing)
      ...
      - [CodeQL - static analysis framework to find bugs](#codeql---static-analysis-framework-to-find-bugs)
      - [The 8 "Laws" of static analysis](#the-8-laws-of-static-analysis)
    - [Automated testing](#automated-testing-1)
      - [Formal verification - model checking/symbolic execution](#formal-verification---model-checkingsymbolic-execution)
        - [(bounde) model checking](#bounde-model-checking)
        - [Symbolic execution](#symbolic-execution)
      - [Fuzzing](#fuzzing)
        - [Blackbox fuzzing](#blackbox-fuzzing)
        - [Greybox fuzzing](#greybox-fuzzing)
        - [Input Generation](#input-generation)
      - [Sanitization - fault detection](#sanitization---fault-detection)
      - [Identifying faults](#identifying-faults)
    - [Comparison of Analyses](#comparison-of-analyses)
  ...
  - [Network security](#network-security)
    ...
    - [Network segmentation](#network-segmentation)
      ...
      - [Virtual segmentation](#virtual-segmentation)
      - ["Zero trust" networks](#zero-trust-networks)
    - [Protecting remote access - Virtual Private Networks](#protecting-remote-access---virtual-private-networks)
      - [VPN](#vpn)
    - [Protecting the perimeter](#protecting-the-perimeter)
      - [Firewalls](#firewalls)
      - [Proxies](#proxies)
    ...
    - [Protecting the workstation](#protecting-the-workstation)
      - [Preventing the privilege escalation](#preventing-the-privilege-escalation)
      - [Protecting History - logging](#protecting-history---logging)
        - [Things you should never log](#things-you-should-never-log)
      - [Protecting History - backups](#protecting-history---backups)
  - [Exercises 8](#exercises-8)
  - [Mobile security](#mobile-security)
    - [Mobile security motivation](#mobile-security-motivation)
    - [Attack vectors](#attack-vectors)
      - [Types of malware: repackagring / look-alike Malware](#types-of-malware-repackagring--look-alike-malware)
      - [Privacy of digital content](#privacy-of-digital-content)
      - [Broader - Political instrument](#broader---political-instrument)
    - [Android vs iOS](#android-vs-ios)
      - [Apple's iOS ecosystem is **extremely closed**](#apples-ios-ecosystem-is-extremely-closed)
      - [Google's strategy](#googles-strategy)
    - [ARM - ARMv8](#arm---armv8)
      - [ARM processor profiles](#arm-processor-profiles)
      - [ARM ARMv8 privilege levels](#arm-armv8-privilege-levels)
      - [Details of ARMv8 ISA](#details-of-armv8-isa)
    - [Android ecosystem and security](#android-ecosystem-and-security)
      - [Android Open Source Project (AOSP)](#android-open-source-project-aosp)
      - [Chip -\> phone](#chip---phone)
      - ["Open" in AOSP](#open-in-aosp)
      - ["not-so-Open" in AOSP](#not-so-open-in-aosp)
      - [Android devices](#android-devices)
      - [Android fragmentation](#android-fragmentation)
      - [Lif og a security bug](#lif-og-a-security-bug)
      - [Perils of customization](#perils-of-customization)
      - [Most devices don;t get security patches](#most-devices-dont-get-security-patches)
      - [Role of Security researchers](#role-of-security-researchers)
      - [Attacker goals vs security researchers](#attacker-goals-vs-security-researchers)
    - [Android Apps](#android-apps)
      - [Basics on Android apps](#basics-on-android-apps)
      - [4 Component types](#4-component-types)
        - [Activity](#activity)
        - [Service](#service)
        - [Broadcast receiver](#broadcast-receiver)
        - [Content provider](#content-provider)
        - [Communication between components - intents](#communication-between-components---intents)
      - [Manifest file](#manifest-file)
    - [App security](#app-security)
      - [App installation](#app-installation)
      - [Android Framework Architecture](#android-framework-architecture)
        - [asking the OS for favors, aka syscalls](#asking-the-os-for-favors-aka-syscalls)
        - [Example - getLastLocation()](#example---getlastlocation)
      - [Crossing the bridge](#crossing-the-bridge)
        - [Binder RPC](#binder-rpc)
        - [Binder Details](#binder-details)
      - [Androind permission system](#androind-permission-system)
    - [Reversing Android Apps](#reversing-android-apps)
      - [Compilation](#compilation)
      - [Android Application Package (APK)](#android-application-package-apk)
      - [Big picture](#big-picture)
      - [Disassemble vs decompilation](#disassemble-vs-decompilation)
    - [Kernel security and SELinux](#kernel-security-and-selinux)
  ...
  - [Trusted Computing](#trusted-computing)
    ...
    - [What if we can trust the hardware](#what-if-we-can-trust-the-hardware)
      - [Properties of trusted hardware](#properties-of-trusted-hardware)
    - [Trusted hardware](#trusted-hardware)
      - [Trusted execution environments (TEE)](#trusted-execution-environments-tee)
      - [Trusted Platform Module (TPM)](#trusted-platform-module-tpm)
        - [TPM Attestation](#tpm-attestation)
        - [TPM Sealing](#tpm-sealing)
      - [Trusted Hardware Key Properties - Isolation](#trusted-hardware-key-properties---isolation)
      - [Hardware Secure Modules (HSMs)](#hardware-secure-modules-hsms)
        - [Use-case: secure iPhone backups](#use-case-secure-iphone-backups)
      - [Smartcards](#smartcards)
        - [Use-case: Offline payments](#use-case-offline-payments)
    - [Side channels](#side-channels)
      - [Types of side channels](#types-of-side-channels)
      - [Timing attack - Naive RSA](#timing-attack---naive-rsa)
      - [Power side channels](#power-side-channels)
      - [Electromagnetic side channels](#electromagnetic-side-channels)
      - [Countermeasures](#countermeasures)
      - [Attacks against Intel SGX](#attacks-against-intel-sgx)
    - [Microarchitectural side-channels](#microarchitectural-side-channels)
      - [Meltdown](#meltdown)
        - [Meltdown steps](#meltdown-steps)
        - [Meltdown possible mitigations](#meltdown-possible-mitigations)
      - [Spectre](#spectre)
        - [Spectre steps](#spectre-steps)
        - [Spectre possible mitigations](#spectre-possible-mitigations)
      - [Active mitigations](#active-mitigations)
